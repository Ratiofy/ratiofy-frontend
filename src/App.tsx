  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 border-r border-border bg-background/80 backdrop-blur-xl z-50 flex flex-col">
      <div className="p-8 flex items-center gap-3">
        <div className="w-8 h-8 rounded-lg bg-success flex items-center justify-center shadow-[0_0_15px_var(--color-success-foreground)]">
  ...
  return (
    <div className="font-sans min-h-screen">
      <Routes>
        ...
        {/* Dashboard Principal - Radar de Valor */}
        <Route path="/" element={
          <ProtectedRoute>
